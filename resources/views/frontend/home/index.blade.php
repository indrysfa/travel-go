                        ...
                        <form class="main-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                                    <a href="{{ route('sewa.show') }}">Search</a>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12 ">
                    <div class="titlepage">
                        ...
                        <span> Setiap Apartemen by Travel-GO Property Management, baik furnished dan unfurnished melewati
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                        <div class="about-box">
                            <p> <span>Travel-Go Realty menghubungkan penyewa dengan pemilik dengan cara yang revolusioner
                                    dan servis profesional. Dengan fitur foto 360°, inspeksi langsung serta opsi pembayaran
                                    yang fleksibel, penyewaan tempat tinggal tidak pernah semudah ini.<br>Dan ada promosinya
                        ...
                        <div class="owl-carousel owl-theme">
                            <div class="item">
                                ...
                                <p style="text-align: justify">Bermodalkan tempat strategis, jelas Anda dapat mengakses
                                    ...
                                    dengan jalur transportasi modern seperti kereta listrik, MRL/LRT atau bus kota. Hal ini
                                    jelas membuat Anda tak perlu repot saat ingin ke mall atau bepergian tanpa kendaraan
                                    pribadi sekalipun. Jika tinggal di apartemen, anda tidak membutuhkan ruangan yang luas.
                                    Kebanyakan orang memilih unit apartemen karena kemudahan akses, keamanan, dan fasilitas.
                                    Fasilitas yang disediakan juga disesuaikan dengan kebutuhan gaya hidup jaman sekarang.
                                    Seperti fasilitas komersial area, minimarket, kolam renang, jogging track dan fitness
                                    center. Keuntungan lainnya jika Anda memilih apartemen ialah keamanan yang terjamin. Ada
                                    satu hal yang tak akan bisa didapat jika tinggal di rumah yakni pemandangan keren dari
                                    ketinggian. Anda bisa melihat warna warni lampu ketika malam hari dan melihat matahari
                            ...
                            <div class="item">
                                ...
                                <p style="text-align: justify">Di Travel-Go.com, anda dapat menemukan dua type akomodasi.
                                    Akomodasi By Travel-Go dan Independent Listing. Akomodasi bertuliskan By Travel-Go
                                    merupakan akomodasi yang di kelola langsung oleh team terlatih dari Travel-Go dan dengan
                                    ...
                                    Untuk menyesuaikan dengan kebutuhan Anda, kami menyewakan unit kami secara sewa harian,
                                    bulanan dan tahunan.<br>
                                    Sebelum proses pengelolaan, setiap Apartemen melalui proses standarisasi dan verifikasi
                                    oleh tim kami untuk menjamin kenyamanan Anda. Anda pun bisa memilih unit dengan 3 kelas
                                    yang berbeda. Kami menyediakan tiga segmentasi kelas standard, deluxe dan premium.
                                    Selain itu, harga yang Travel-Go tawarkan dengan unit apartemen yang telah berstandar
                            ...
                            <div class="item">
                                ...
                                <p style="text-align: justify">Berikut keuntungan jika anda sewa harian unit apartemen di
                                    Travel-Go : Unit yang kami kelola sudah di standarisasi dan dilengkapi dengan amenities,
                                    linen dengan kualitas berbintang, wifi dan sudah lengkap dengan furniture seperti AC,
                                    ...
                                    memanfaatkan fasilitas cicilan bayar TANPA menggunakan kartu kredit. Adapun juga kami
