        ...
        <div class="row">
            <div class="col-12">
                <div class="py-4">
                    ...
                    <a href=" {{ route('backend.kategori-building.create') }} " class="btn btn-primary"> Tambah Building
                        / Tower </a>
                </div>
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            {{-- ada 3 col --}}
                            <th scope="col">#</th>
                            <th scope="col">Nama Building/Tower</th>
                            <th scope="col">Action</th>
                        </tr>
                    </thead>
                    <tbody>
                        @forelse ($backendKategoriBuilding as $bkb)
                            ...
                            {{-- Method 1 (works!!!) --}}
                            <td><a
                                    href="{{ route('backend.kategori-building.show', ['backendSewaDataProperty' => $bkb->id]) }}">
                                    {{ $bkb->nm_building_id }} </a>
                            </td>
